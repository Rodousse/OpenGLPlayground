...
int main(int argc, char* argv[])
{
    ...
    QuadLightData lightData{{10.0f, 10.0f}, {1.0f, 1.0f, 1.0f}, {10.0f, .0f, .0f}};
    ...
    Renderer renderer(shaders, scene.cameras[0], sceneData);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        {
            ImGui::ColorEdit3("Light Color", lightData.color.data());
